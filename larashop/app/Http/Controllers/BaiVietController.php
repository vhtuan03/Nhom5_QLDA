...
class BaiVietController extends Controller
{
	...
	public function storeComment(Request $request)
	{
		...
		// Assuming you have a model for comments
		$comment = new Comment();
		$comment->baiviet_id = $request->baiviet_id;  // You need to pass the post ID somehow (maybe via hidden input)
		$comment->user_id = auth()->id(); // Assuming the user is logged in
		$comment->noidungbinhluan = $request->noidungbinhluan;
		$comment->save();
